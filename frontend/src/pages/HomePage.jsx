...
const HomePage = () => {
    return (
        <div className='flex flex-col max-w-7xl  mx-auto bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.08)_0%,transparent_70%)]'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full pt-10'>
            ...
            <div className='bg-white max-w-7xl  mx-auto mt-10 mb-10 p-12 rounded-2xl shadow-lg'>
                <div className='grid gap-12 grid-cols-2'>
                    <div className='flex flex-col'>
                        <h1 className='font-heading font-bold tracking-wide text-slate-900 text-3xl'>Curated stories in your inbox</h1>
                        <p>Join our newsletter to get the best of StackScribe delivered weekly to your email.</p>
                    </div>
